...
/*
 ...
 mem-> +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  ...
  chunks are free, and if so, xr_unlink them from the lists that they
...
/*
  ...
  1. If x is a chained node, xr_unlink it from its same-sized fd/bk links
...
/* Unmap and xr_unlink any mmapped segments that don't contain used chunks */
