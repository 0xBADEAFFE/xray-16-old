...
*/
// NOTE: This compiles on GCC
//#define SCRIPT_EXPORT_WRAP(id, dependencies, ...) namespace XRay { namespace ScriptExportDetails { static const char *const id##_Deps[] = {nullptr, SCRIPT_INHERIT(NOOP dependencies)}; static void id##_ScriptExport(lua_State *luaState) __VA_ARGS__ static const ScriptExporter::Node id##_ScriptExporterNode(#id, sizeof(id##_Deps) / sizeof(*id##_Deps) - 1, id##_Deps + 1, id##_ScriptExport); } }
//#define SCRIPT_EXPORT_FUNC_WRAP(id, dependencies, func) namespace XRay { namespace ScriptExportDetails { static const char *const id##_Deps[] = {nullptr, SCRIPT_INHERIT(NOOP dependencies)}; static void id##_ScriptExport(lua_State *luaState) { func(luaState); } static const ScriptExporter::Node id##_ScriptExporterNode(#id, sizeof(id##_Deps) / sizeof(*id##_Deps) - 1, id##_Deps + 1, id##_ScriptExport); } }
