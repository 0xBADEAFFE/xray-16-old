...
#include "xrCore/buffer_vector.h" // buffer_vector
...
struct CDestroyer
{
	...
	// NOTE: For xr_vector, is this really working
	template <typename T>
	IC	static void delete_data(xr_vector<T*> &data)
	{
#warning Not tested!
		delete_data(data);
	}

	// NOTE: For buffer_vector, is this really working
	template <typename T>
	IC	static void delete_data(buffer_vector<T*> &data)
	{
#warning Not tested!
		delete_data(data);
	}
