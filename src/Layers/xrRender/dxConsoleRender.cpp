...
void dxConsoleRender::OnRender(bool bGame)
{
	...
	verts->set						( (float)R.x1,	(float)R.y2, (float)color_xrgb(32,32,32), 0.f, 0.f );	verts++;
	verts->set						( (float)R.x1,	(float)R.y1, (float)color_xrgb(32,32,32), 0.f, 0.f );	verts++;
	verts->set						( (float)R.x2,	(float)R.y2, (float)color_xrgb(32,32,32), 0.f, 0.f );	verts++;
	verts->set						( (float)R.x2,	(float)R.y1, (float)color_xrgb(32,32,32), 0.f, 0.f );	verts++;
